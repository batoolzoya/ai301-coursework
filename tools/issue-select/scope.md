...
I have a strong background in mathematics and experience using Python and MATLAB for quantitative tasks. I want to gain more hands-on experience with AI engineering workflows, prompt systems, and backend logic, while avoiding front-end UI design tasks.
